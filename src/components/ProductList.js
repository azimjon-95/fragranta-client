...
import './style.css';
import { Button, Input, message, Skeleton, Row, Col, Modal } from 'antd';
...
const ProductList = () => {
    ...
    const editProduct = (product) => {
        ...
        setShowForm(true);
        window.scrollTo({ top: 10, behavior: 'smooth' }); // Scroll to the top smoothly
    };
                        ...
                        <Input
                            ...
                            suffix={searchTerm &&
                                <Button
                                    ...
                                    onClick={resetSearch}
                                    className='reset-button' // Style for reset button
                                />
                            }
                        />
                    ...
                    {filteredProducts.map((product) => (
                        <div key={product._id} className={`product-item ${animateProductId === product._id ? 'animate' : ''}`}>
                            ...
                            <div className="AddActions-cart">
                                ...
                                <Button style={{ border: "1px solid red" }} onClick={() => deleteProduct(product._id)} icon={<DeleteOutlined />} danger></Button>
                            </div>
                        </div>
                    ))}
                </div>
